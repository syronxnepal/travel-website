...
const TopTrekSectionPage: React.FC = () => {
  const [formData, setFormData] = useState({
    topTitle: 'Trekking',
    heading: 'Explore Our Top Trekking Destinations'
  });
      ...
      <div className="cms-page">
        <div className="section-cms">
          <div className="section-cms__header">
            <h3>Top Trek Section - Top Title & Heading</h3>
            <p>Configure the top title and heading for the Top Trek section on the homepage</p>
          </div>
...
export default TopTrekSectionPage;
